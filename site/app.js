 ...
 * Data comes from build_graph.py (data/graph.json, data/people.json, data/notes/<id>.md).
...
async function noteText(id) {
  if (!noteCache.has(id)) noteCache.set(id, fetch(`data/notes/${id}.md`).then((r) => r.text()));
